...
for i in range(1, 20):  # Empezando desde 1 término hasta 19 términos
    ...
    # Si el error absoluto es menor que 1, termina el bucle
    if e_error < 1:
        break
    # Imprime el número de términos, la aproximación, el valor real y el error absoluto
    print(f'{i} términos: Serie de Taylor aproximada = {e_aprox}\t exponente calculado = {e_exp}\t error: {e_error}')
